...
const menuItems = [
  { href: '/', label: 'Home', sanskritName: 'गृह', icon: Home },
  { href: '/temples', label: 'Temples', sanskritName: 'मन्दिराणि', icon: Building },
  { href: '/services', label: 'Services', sanskritName: 'सेवाः', icon: Flower2 },
  { href: '/chat', label: 'Divine Chat', sanskritName: 'संवादः', icon: MessageCircle },
  { href: '/profile', label: 'Profile', sanskritName: 'विवरणम्', icon: User },
]
      ...
      <div className={`fixed top-0 right-0 h-full w-80 bg-sankalpa-cream-light shadow-xl z-50 transform transition-transform duration-300 ${
        ...
        <div className="bg-gradient-to-br from-sankalpa-gold-light to-sankalpa-light p-6 relative">
          ...
          <div className="text-center mt-4">
            ...
            <h3 className="font-serif text-xl text-sankalpa-dark">Namaste, {userName}</h3>
            <p className="text-sm text-sankalpa-dark/70 mt-1 font-serif italic">
              शुभं भवतु
            </p>
          </div>
        </div>
          ...
          {menuItems.map((item) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-sankalpa-dark/60 font-serif">{item.sanskritName}</p>
              </div>
            </Link>
          ))}
        </nav>
